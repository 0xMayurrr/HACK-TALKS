...
const speakers = [
  { name: "Mayur P", role: "Lead Speaker", tag: "Innovation Ambassador", bio: "Innovating across Web3, AI & Product Development.", photo: "/Mayur.png", color: "purple", linkedin: "https://www.linkedin.com/in/mayurp03/", imgPosition: "center 25%" },
  ...
  { name: "Joshva I", role: "Junior Speaker", tag: "DevOps Enthusiast", bio: "DevOps enthusiast passionate about building scalable systems and automating infrastructure.", photo: "/joshva 44.jpeg", imgPosition: "center 25%", color: "yellow", linkedin: "https://www.linkedin.com/in/joshva-i-05a9a4373/" },
  { name: "Mohamed Irfan", role: "Technical Mentor", tag: "Blockchain & Social", bio: "Ideology entrepreneur through blockchain and socializing.", photo: "/irfan.png", color: "purple", linkedin: "https://www.linkedin.com/in/mhmdd-irfan-3a3229322/", imgPosition: "center 25%" },
  ...
  <Layout>
    ...
    <section className="py-16 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4">
        <p className="text-center text-purple font-black text-xs uppercase tracking-widest mb-10">Our Speakers</p>
              ...
              <div className="flex flex-col items-center">
                <div className="mentor-card-container">
                  <div className="mentor-card-img-wrapper">
                    <img src={s.photo} alt={s.name} className="mentor-card-img" style={{ objectPosition: (s as any).imgPosition ?? "center 20%" }} />
                  </div>
                </div>
                <ul className="mentor-card-socials">
                  <li className="mentor-card-social-item">
                ...
                <div className="mt-3 text-center w-[180px]">
                  <p className="font-heading font-bold text-foreground text-sm">{s.name}</p>
                  <p className="text-purple font-black text-[10px] uppercase tracking-widest mt-0.5 mb-1">{s.role}</p>
